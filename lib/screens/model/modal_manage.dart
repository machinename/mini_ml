...
class _ModelManageState extends State<ModelManage> {
  ...
  void _pushToModelName() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => const ModelName()));
  }

  void _pushToModelDescription() {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => const ModelDescription()));
  }

  void _pushToModelDelete() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => const ModelDelete()));
  }
